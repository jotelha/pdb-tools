...
Usage:
    python pdb_reres_by_atom.py -<number> <pdb file>

Example:
    python pdb_reres_by_atom.py -10 1CTF.pdb  # renumbers from 10
    python pdb_reres_by_atom.py --1 1CTF.pdb  # renumbers from -1
